...
object Rand {
    ...
    fun amount(from: Double = 0.01, to: Double = 100.0): Double = Random.nextDouble(from, to).round(2)

    fun percentage(): Double = Random.nextDouble(0.0, 100.0).round(2)

    fun age(min: Int = 18, max: Int = 99): Int = Random.nextInt(min, max + 1)
    ...
    fun email(): String = "${alphabetic(Random.nextInt(5, 15)).lowercase()}@${alphabetic(Random.nextInt(5, 10)).lowercase()}.com"
